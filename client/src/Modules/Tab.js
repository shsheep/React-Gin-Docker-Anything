...
class Tab extends Component {
    ...
    handleTest(e) {
        ...
        axios.post(hostAddress + "/api/tab-upload", formData, config)
            .then((res) => {
    ...
    parseResult() {
        ...
        axios.get(hostAddress + "/api/tab-get-result").then((data) => {
            const tmp = data
            console.log(tmp)
    ...
    async handleUploadTest() {
        ...
        await axios.post(hostAddress + "/api/tab-write-get-result/", {
        ...
        return (
            <div className="container">
                ...
                <div className="form-group">
                    ...
                    <small id="fileHelp" className="form-text text-muted">PDF로 바꿀 기타 프로 파일을 업로드하세요.</small>
